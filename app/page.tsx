  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <AuthButton
                  ...
                  className="w-full sm:w-auto bg-transparent backdrop-blur border border-white text-white hover:bg-white/5 cursor-pointer px-6 py-3 rounded-lg transition-colors duration-200 flex items-center justify-center"
                >
                  {isLoggedIn ? (
                    "Check it Out"
                  ) : (
        ...
        <section className="py-16 md:py-24 bg-linear-to-b from-gray-900 to-gray-800 text-gray-100">
          <div className="container mx-auto px-4 text-center">
            ...
            <AuthButton
              isLoggedIn={isLoggedIn}
              className="inline-block cursor-pointer bg-white text-gray-800 hover:bg-blue-50 px-6 py-3 rounded-lg transition-colors duration-200"
            >
